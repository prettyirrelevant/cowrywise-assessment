...
SECRET_KEY = env.str('BOOKWORM_SECRET_KEY')

ALLOWED_HOSTS = env.list('BOOKWORM_ALLOWED_HOSTS', default=[]) if DEBUG else env.list('BOOKWORM_ALLOWED_HOSTS')
...
LOCAL_APPS = ['bookworm.apps.books', 'bookworm.apps.users']
...
# ==============================================================================
DATABASES = {'default': env.dj_db_url('BOOKWORM_DATABASE_URL')}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': ['bookworm.apps.books.permissions.IsEnrolledUser'],
...
# PAGEKEEPER SETTINGS
# ==============================================================================
AUTHENTICATION_SERVER_URL = env.str('BOOKWORM_AUTHENTICATION_SERVER_URL')

# ==============================================================================
# BOOKCOURIER SETTINGS
# ==============================================================================
BOOKCOURIER = BookCourier(env.str('BOOKWORM_RABBITMQ_URL'))
